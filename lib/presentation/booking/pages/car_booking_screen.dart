...
import 'package:urbandrive/presentation/features/location_search.dart';
      ...
      child: Center(
        child: RichText(
            ...
            text: TextSpan(style: TextStyle(color: Colors.blue), children: [
              ...
              TextSpan(
                  text: "\n${startdate.day}", style: TextStyle(fontSize: 60)),
        ...
        child: RichText(
            ...
            text: TextSpan(style: TextStyle(color: Colors.blue), children: [
              TextSpan(
                  text: "Drop -Off\n",
                  style: TextStyle(fontWeight: FontWeight.w500)),
              TextSpan(text: "${enddate.day}", style: TextStyle(fontSize: 60)),
              TextSpan(
                  style: TextStyle(
                    wordSpacing: 10,
                  ),
