...
class CarBookingScreen extends StatefulWidget {
  CarBookingScreen({super.key, required this.carId, required this.userId});
...
class _CarBookingScreenState extends State<CarBookingScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(body: BlocBuilder<CarBookingBloc, CarBookingState>(
                          ...
                          trailing: TextButton(
                            ...
                            child: Text(
                              ...
                              style: TextStyle(
                                  fontSize: 12,
                                  color:
                                      const Color.fromARGB(255, 62, 158, 206)),
                            ),
                          ),
                        )),
                    SizedBox(
    ...
    ), bottomSheet: BlocBuilder<CarBookingBloc, CarBookingState>(
      builder: (context, state) {
